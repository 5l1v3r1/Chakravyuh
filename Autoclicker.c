/*
Author : R41P41
Auto Click on buttons which have keywords
can be used to automate installers
mingwgcc extra switches : -nostdlib -s -lkernel32 -luser32 -lmsvcrt
*/
#include<windows.h>
#include<stdio.h>
#include<commctrl.h>
...
int winmaincrtstartup()
{
	   ...
	   CloseHandle(hwDesktop);
        while(1)
        {
        		//RandomMouseMove used for GetCursorPos() AntiVM
                //RandomMouseMove();
                FindParent();
                Sleep(100);
        }
